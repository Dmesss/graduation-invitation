    ...
    <section id="wishes" className="min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        ...
        >
          ...
          {/* WhatsApp Button */}
          <motion.a
            href="https://wa.me/6285697900510?text=Assalamu%27alaikum%20Ustadzah%20Ninda%2C%20saya%20ingin%20konfirmasi%20kehadiran%20untuk%20acara%20wisuda."
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-2 bg-emerald-500 text-white px-6 py-3 rounded-xl shadow-md hover:bg-emerald-600 transition-all duration-200 text-lg font-medium"
          >
            <svg
